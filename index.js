...
const imageLoader = () => {
  ...
  if (hour <= 7 || hour >= 18) {
    ...
    <img src ='./tropical-landscape-with-sea-bay-at-night-vector-44810384.jpg'></img>
    `;
  } else
    weatherImage.innerHTML = `
    <img src ='./gorgeous-clouds-background-with-blue-sky-design_1017-25501.avif' alt ='image'></img>
    `;
